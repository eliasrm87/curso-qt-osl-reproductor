...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        listWidget = new QListWidget(AboutDialog);
        ...
        QObject::connect(pushButton, SIGNAL(pressed()), AboutDialog, SLOT(close()));
    ...
    void retranslateUi(QDialog *AboutDialog)
    {
        ...
        pushButton->setText(QApplication::translate("AboutDialog", "Cerrar", 0));
    } // retranslateUi
